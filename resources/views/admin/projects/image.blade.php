...
@section('content')
    <main class="app-content">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3>New project Image and Video</h3>
                            <div class="ermsg"></div>
                        </div>
                        <div class="card-body">
                            <div class="row">
        ...
        <a href="{{ route('admin.project')}}" id="backBtn" class="btn btn-success">Back</a>
                                ...
                                <div class="container">
                                    ...
                                    <table class="table table-bordered table-hover" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              <td>{{$key + 1}}</td>
                                              <td>{{\App\Models\Project::where('id','=',$data->project_id)->first()->title }}</td>
...
var storedFiles2 = [];
        ...
        $(document).ready(function () {
            ...
            var url = "{{URL::to('/admin/project-image')}}";
            var dlturl = "{{URL::to('/admin/project-image-delete')}}";
            // console.log(url);
