  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.client')}}" id="client"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">About</span></a></li>
        @endif
        ...
        <li class="treeview" id="allreviews"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Review</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{ route('admin.reviews')}}" id="reviews"><i class="icon fa fa-circle-o"></i> Add Review</a></li>
          </ul>
        </li>
        ...
        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{route('admin.project')}}" id="project"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Projects</span></a></li>
        @endif

        <!--<li class="treeview" id="allgallery"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Project</span><i class="treeview-indicator fa fa-angle-right"></i></a>-->
        <!--  <ul class="treeview-menu">-->
        ...
        <!--    <li><a class="treeview-item" href="{{ route('admin.gallery')}}" id="gallery"><i class="icon fa fa-circle-o"></i> Add Project Image</a></li>-->
        <!--  </ul>-->
        <!--</li>-->
